    ...
    <div className="flex flex-col min-h-screen">
      ...
      <StickySection zIndex={10} className="">
        <section className="bg-[var(--primary)] text-white py-16 md:py-24 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-[var(--accent)]/20 rounded-full mix-blend-overlay filter blur-3xl transform translate-x-1/2 -translate-y-1/2" />
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            >
              Pilih layanan yang Anda butuhkan. Kami siap membantu menyediakan
              data dan informasi statistik terbaik untuk Anda.
            </motion.p>
          </div>
        </section>
      </StickySection>
                ...
                <motion.div key={service.id} variants={itemVariants}>
                  <Card className="h-full flex flex-col border-none shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-white group">
                    <CardHeader className="pb-4">
                      ...
                      <CardTitle className="text-2xl text-[var(--primary)] font-bold">
                        {service.title}
                      </CardTitle>
                    </CardHeader>
